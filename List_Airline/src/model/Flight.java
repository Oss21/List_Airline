...
public class Flight  implements Comparable<Flight>, Comparator<Flight>{
	...
	public Flight(int numberOfFlight, int portOfShipment,int day, int month, int year,
			String destinationCity, String airline, int hour, int minute , String period) {
	...
	public Flight(int hour, int minute, String period) {
		time = new Time(hour, minute, period);
	}
	...
	public String toString() {
		return "Flight [numberOfFlight=" + numberOfFlight + ", day=" + day + ", month=" + month + ", year=" + year
				+ ", destinationCity=" + destinationCity + ", portOfShipment=" + portOfShipment + ", airline=" + airline
				+ ", time=" + time + ", nextFlight=" + nextFlight.toString() + ", previusFlight=" + previusFlight + "]";
	}
